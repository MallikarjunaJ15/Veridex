  ...
  return (
    <>
      ...
      <div className="font-syne bg-[#080808] text-[#f0ede8] overflow-x-hidden min-h-screen">
        {/* NAV */}
        <nav
          className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-12 py-[18px] transition-all duration-300 ${scrolled ? "bg-[#080808]/90 backdrop-blur-xl border-b border-white/[0.06]" : "bg-transparent border-b border-transparent"}`}
        >
